      ...
      <div className="max-w-full mx-auto">
        ...
        <div className="mt-2 text-xs text-muted-foreground max-w-md mx-auto mb-8">
          <details className="group">
            ...
            <div className="pt-2 pb-1 px-4 mt-1 rounded-md bg-background/50 border text-left">
              <p className="mb-1.5">
                Atualmente a filtragem por disciplina não está disponível devido às limitações da{' '}
                <a
                ...
                . Apenas a filtragem por ano é suportada.
              </p>
              <p className="text-amber-700 dark:text-amber-400 mt-2 flex items-start gap-1.5">
                ...
                <span>
                  <strong>Importante:</strong> Esta aplicação utiliza uma API não-oficial
                  desenvolvida e mantida pela comunidade (
                  <a
                    href="https://enem.dev"
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  ), sem vínculos com o INEP ou o MEC.
                </span>
              </p>
            </div>
          </details>
        ...
        <div className="mb-4 flex flex-col sm:flex-row justify-between gap-2">
          <p className="text-muted-foreground text-sm">
            {totalQuestions} {totalQuestions === 1 ? 'questão encontrada' : 'questões encontradas'}{' '}
            de {selectedYear}
          </p>
          {totalPages > 1 && (
            <p className="text-muted-foreground text-sm">
              ...
              questions.map(question => {
                ...
                return (
                  ...
                  >
                    <CardHeader className="pb-2">
                      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2">
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          {answerHistory && (
                            <Badge
                              variant={answerHistory.isCorrect ? 'success' : 'destructive'}
                              className="text-xs"
                            >
                        ...
                        {question.alternatives &&
                          question.alternatives.map(alternative => {
                            ...
                            `}
                              ...
                              >
                                <div
                                  className={`flex items-center justify-center h-5 w-5 rounded-full border ${isSelected ? 'border-primary bg-primary text-primary-foreground' : 'border-muted-foreground'}`}
                                >
                                  {isSelected && <span className="text-xs font-bold">✓</span>}
                                </div>
                                <div className="flex-1">
                                  <div className="flex">
                                    <span className="font-medium w-6 shrink-0">
                                      {alternative.letter}){' '}
                                    </span>
                                    <div className="flex-1">
                                ...
                                {alternative.file && (
                                  <img
                                    ...
                                    className="max-w-full h-auto mt-1 rounded-md"
                                    loading="lazy"
                                  />
                                )}
                              </div>
                    ...
                    <CardFooter className="flex flex-col sm:flex-row justify-between border-t pt-3 gap-2">
                      {userAnswer?.isChecked ? (
                        <>
                          <div
                            className={`text-sm ${userAnswer.isCorrect ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}
                          >
